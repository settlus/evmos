...
// AddDynamicPrecompiles provides a mock function with given fields: ctx, precompiles
func (_m *EVMKeeper) AddDynamicPrecompiles(ctx types.Context, precompiles ...vm.PrecompiledContract) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddDynamicPrecompiles")
	}
